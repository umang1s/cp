...
void identify();            void addition();         void display();         void insert_node(components *)  ;                                                 //all fuction use in this program
int main()
{
    int i;
    ...
    while(i !=0)
    {
        ...
        printf("enter the second expression\n");       gets(second_node->expression);                        //printing and scanning seoonds expression
        ...
        printf("enter 0 for exit or 1 for again run\n");
